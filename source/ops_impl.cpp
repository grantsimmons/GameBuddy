...
void Z80::INCB(){
    ...
    this->_r.f = this->_r.b & 0x1F == 0x10 ? (this->_r.f | HALF_CARRY) : (this->_r.f & ~(HALF_CARRY));
    this->_r.f &= ~(ADD_SUB);
}
...
void Z80::INCC(){
    ...
    this->_r.f = this->_r.c & 0x1F == 0x10 ? (this->_r.f | HALF_CARRY) : (this->_r.f & ~(HALF_CARRY));
    this->_r.f &= ~(ADD_SUB);
}
...
void Z80::INCD(){
    ...
    this->_r.f = this->_r.d & 0x1F == 0x10 ? (this->_r.f | HALF_CARRY) : (this->_r.f & ~(HALF_CARRY));
    this->_r.f &= ~(ADD_SUB);
}
...
void Z80::INCE(){
    ...
    this->_r.f = this->_r.e & 0x1F == 0x10 ? (this->_r.f | HALF_CARRY) : (this->_r.f & ~(HALF_CARRY));
    this->_r.f &= ~(ADD_SUB);
}
...
void Z80::INCH(){
    ...
    this->_r.f = this->_r.h & 0x1F == 0x10 ? (this->_r.f | HALF_CARRY) : (this->_r.f & ~(HALF_CARRY));
    this->_r.f &= ~(ADD_SUB);
}
...
void Z80::INCL(){
    ...
    this->_r.f = this->_r.l & 0x1F == 0x10 ? (this->_r.f | HALF_CARRY) : (this->_r.f & ~(HALF_CARRY));
    this->_r.f &= ~(ADD_SUB);
}
...
void Z80::INCA(){
    ...
    this->_r.f = this->_r.a & 0x1F == 0x10 ? (this->_r.f | HALF_CARRY) : (this->_r.f & ~(HALF_CARRY));
    this->_r.f &= ~(ADD_SUB);
}
...
void Z80::ERLCB(){
    ...
    this->_r.b = this->_r.b << 1 | ((this->_r.b & 0x80) ? 1 : 0);
    this->_r.f = (this->_r.b == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
...
void Z80::ERLCC(){
    ...
    this->_r.c = this->_r.c << 1 | ((this->_r.c & 0x80) ? 1 : 0);
    this->_r.f = (this->_r.c == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
...
void Z80::ERLCD(){
    ...
    this->_r.d = this->_r.d << 1 | ((this->_r.d & 0x80) ? 1 : 0);
    this->_r.f = (this->_r.d == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
...
void Z80::ERLCE(){
    ...
    this->_r.e = this->_r.e << 1 | ((this->_r.e & 0x80) ? 1 : 0);
    this->_r.f = (this->_r.e == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
...
void Z80::ERLCH(){
    ...
    this->_r.h = this->_r.h << 1 | ((this->_r.h & 0x80) ? 1 : 0);
    this->_r.f = (this->_r.h == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
...
void Z80::ERLCL(){
    ...
    this->_r.l = this->_r.l << 1 | ((this->_r.l & 0x80) ? 1 : 0);
    this->_r.f = (this->_r.l == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
...
void Z80::ERLCmHL(){
    ...
    this->mmu.wb((this->_r.h << 8) | this->_r.l, (this->mmu.rb((this->_r.h << 8) | this->_r.l) << 1) | ((this->mmu.rb((this->_r.h << 8) | this->_r.l)) & 0x80) ? 1 : 0);
    this->_r.f = (this->mmu.rb((this->_r.h << 8) | this->_r.l) == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
...
void Z80::ERRCB(){
    this->_r.f = (this->_r.b & 0x01) ? this->_r.f | CARRY : this->_r.f & ~(CARRY);
    this->_r.b = this->_r.b >> 1 | ((this->_r.b & 0x01) ? 1 << 7 : 0);
    this->_r.f = (this->_r.b == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}

void Z80::ERRCC(){
    this->_r.f = (this->_r.c & 0x01) ? this->_r.f | CARRY : this->_r.f & ~(CARRY);
    this->_r.c = this->_r.c >> 1 | ((this->_r.c & 0x01) ? 1 << 7 : 0);
    this->_r.f = (this->_r.c == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}

void Z80::ERRCD(){
    this->_r.f = (this->_r.d & 0x01) ? this->_r.f | CARRY : this->_r.f & ~(CARRY);
    this->_r.d = this->_r.d >> 1 | ((this->_r.d & 0x01) ? 1 << 7 : 0);
    this->_r.f = (this->_r.d == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}

void Z80::ERRCE(){
    this->_r.f = (this->_r.e & 0x01) ? this->_r.f | CARRY : this->_r.f & ~(CARRY);
    this->_r.e = this->_r.e >> 1 | ((this->_r.e & 0x01) ? 1 << 7 : 0);
    this->_r.f = (this->_r.e == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}

void Z80::ERRCH(){
    this->_r.f = (this->_r.h & 0x01) ? this->_r.f | CARRY : this->_r.f & ~(CARRY);
    this->_r.h = this->_r.h >> 1 | ((this->_r.h & 0x01) ? 1 << 7 : 0);
    this->_r.f = (this->_r.h == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}

void Z80::ERRCL(){
    this->_r.f = (this->_r.l & 0x01) ? this->_r.f | CARRY : this->_r.f & ~(CARRY);
    this->_r.l = this->_r.l >> 1 | ((this->_r.l & 0x01) ? 1 << 7 : 0);
    this->_r.f = (this->_r.l == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}

void Z80::ERRCmHL(){
    this->_r.f = (this->mmu.rb((this->_r.h << 8) | this->_r.l) & 0x01) ? this->_r.f | CARRY : this->_r.f & ~(CARRY);
    this->mmu.wb((this->_r.h << 8) | this->_r.l, (this->mmu.rb((this->_r.h << 8) | this->_r.l)) >> 1 | ((this->mmu.rb((this->_r.h << 8) | this->_r.l)) & 0x01) ? 1 << 7 : 0);
    this->_r.f = (this->mmu.rb((this->_r.h << 8) | this->_r.l) == 0) ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
...
void Z80::ERLB(){
    bool orig_carry = this->_r.f & CARRY ? 1 : 0;
    this->_r.f &= (this->_r.b & 0x80) ? 0xFF : ~CARRY;
...
void Z80::ERLC(){
    bool orig_carry = this->_r.f & CARRY ? 1 : 0;
    this->_r.f &= (this->_r.c & 0x80) ? 0xFF : ~CARRY;
...
void Z80::ERLD(){
    bool orig_carry = this->_r.f & CARRY ? 1 : 0;
    this->_r.f &= (this->_r.d & 0x80) ? 0xFF : ~CARRY;
...
void Z80::ERLE(){
    bool orig_carry = this->_r.f & CARRY ? 1 : 0;
    this->_r.f &= (this->_r.e & 0x80) ? 0xFF : ~CARRY;
...
void Z80::ERLH(){
    bool orig_carry = this->_r.f & CARRY ? 1 : 0;
    this->_r.f &= (this->_r.h & 0x80) ? 0xFF : ~CARRY;
...
void Z80::ERLL(){
    bool orig_carry = this->_r.f & CARRY ? 1 : 0;
    this->_r.f &= (this->_r.l & 0x80) ? 0xFF : ~CARRY;
...
void Z80::ESWAPB(){
    ...
    this->_r.f = this->_r.b == 0 ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f &= ~(ADD_SUB | HALF_CARRY | CARRY);
}
...
void Z80::ESRLmHL(){
    this->_r.f = this->mmu.rb((this->_r.h << 8) | this->_r.l) & 0x01 ? this->_r.f | CARRY : this->_r.f & ~(CARRY);
    this->mmu.wb((this->_r.h << 8) | this->_r.l, (this->mmu.rb((this->_r.h << 8) | this->_r.l)) >> 1 & ~(0x80));
    this->_r.f = this->mmu.rb((this->_r.h << 8) | this->_r.l) == 0 ? this->_r.f | ZERO : this->_r.f & ~(ZERO);
    this->_r.f = ~(ADD_SUB | HALF_CARRY);
}
